...
wp core install --url=https://tchtaibi.42.fr  --title=${title} --admin_user=${admin_user} --admin_password=${admin_password} --admin_email=${admin_email} --path="/var/www/html/wordpress" --allow-root --skip-email
